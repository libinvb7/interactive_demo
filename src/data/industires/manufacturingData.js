...
const manufacturingData = {
  ...
  StickyScrollContentTitle: {
    title:
      "Transforming Manufacturing Challenges to Opportunities: Why Data Point is your Smartest Solution? ",
    content:
  ...
  cardSectionTitle: {
    title: "How do manufacturing companies use balanced scorecards?",
  },
  counterTitle:{
  ...
  formContents: {
    title: "Start your journey towards enhanced manufacturing performance !",
    desc: "Plan your Strategic alignment with Digital Balanced Scorecard",
  },
  accordionItems: [
    {
      title: "What is the Balance Scorecard for a manufacturing company?",
      content:
