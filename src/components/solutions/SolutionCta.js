...
import ctaEl from "/public/assets/images/solutionCta.png";
  ...
  return (
    <section className=" px-6 mb-20">
      <div className="group container home-cta flex items-center shadow-2xl rounded-lg relative bg-white overflow-hidden py-10   ">
        <Image
          src={ctaEl}
          className="absolute bottom-[-20px] right-0 z-1 group-hover:scale-y-150 transition duration-300"
        />
        <Image
          src={ctaEl}
          className="absolute top-[-20px] left-0 z-1 rotate-180 group-hover:scale-y-150 transition duration-300"
        />
